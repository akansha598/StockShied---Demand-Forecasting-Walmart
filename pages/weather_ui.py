...
def fetch_weather_forecast(location="Dallas,TX"):
    ...
    try:
        ...
        if 'days' not in data or not isinstance(data['days'], list):
            raise ValueError("Response does not contain valid 'days' data.")
...
if location:
    ...
    if forecast_df.empty:
        st.warning("⚠️ Could not load weather data. Please check the location or try again.")
    else:
        st.success("✅ Weather forecast loaded!")
